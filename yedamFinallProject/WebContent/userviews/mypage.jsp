...
<link rel="stylesheet" type="text/css"
	href="<%=cssPath%>/styles/bootstrap4/bootstrap.min.css">
<link
	href="<%=cssPath%>/plugins/font-awesome-4.7.0/css/font-awesome.min.css"
	rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css"
	href="<%=cssPath%>/plugins/OwlCarousel2-2.2.1/owl.carousel.css">
<link rel="stylesheet" type="text/css"
	href="<%=cssPath%>/plugins/OwlCarousel2-2.2.1/owl.theme.default.css">
<link rel="stylesheet" type="text/css"
	href="<%=cssPath%>/plugins/OwlCarousel2-2.2.1/animate.css">
<link rel="stylesheet"
	href="<%=cssPath%>/plugins/themify-icons/themify-icons.css">
<link rel="stylesheet" type="text/css"
	href="<%=cssPath%>/plugins/jquery-ui-1.12.1.custom/jquery-ui.css">
<link rel="stylesheet" type="text/css"
	href="<%=cssPath%>/styles/contact_styles.css">
<link rel="stylesheet" type="text/css"
	href="<%=cssPath%>/styles/contact_responsive.css">
		...
		<div class="main_slider">
			<div class="container contact_container">
						...
						<div class="breadcrumbs d-flex flex-row align-items-center">
							<ul>
								...
								<li class="active"><a href="#"><i
										class="fa fa-angle-right" aria-hidden="true"></i>${id }님의 구매내역</a></li>
							</ul>
						</div>
				...
				<div class="row" id="tdiv">
						...
						<c:choose>
							<c:when test="${not empty MyPageList }">
								<c:forEach var="list" items="${MyPageList }">
									<tr id="trHover">
										<td class="align-middle text-center" width="150px"><a
											href="single.do?sleId=${list.sleId }"><img
												src="${list.photoString}" width="100px" height="100px"
												alt=""> </a></td>
										...
										<td class="align-middle text-center">
											<button type="button" id="wayBtn" name="wayBtn"
												onclick="openWay();">길 안내</button>
										</td>
									</tr>
									<input type="hidden" id="cmpnm" name="cmpnm"
										value="${list.cmpnm }">
					...
					<div>
						<iframe src="" id="findWay" name="findWay" width="100%"
							height="1000px" scrolling="yes" frameborder="0"
							style="border-radius: 10px; display: none"></iframe>
					</div>
				</div>
